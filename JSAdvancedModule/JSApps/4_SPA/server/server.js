(function (global, factory) {
    ...
    console.log(process.cwd()+" lk");
    const dataDir = './server/data';
    const data = fs__default['default'].existsSync(dataDir) ? fs__default['default'].readdirSync(dataDir).reduce((p, c) => {
        const content = JSON.parse(fs__default['default'].readFileSync(dataDir+'/' + c));
    ...
    const actions = {
        get: (context, tokens, query, body) => {
            console.log('Get action:'+JSON.stringify(data)+' '+tokens);
        ...
        post: (context, tokens, query, body) => {
            ...
            console.log("after post: "+responseData[newId]);
    ...
    function parseWhere(query) {
        const operators = {
            ...
            '>=': (prop, value) => record => record[prop] >= JSON.parse(value),
            '>': (prop, value) => record => record[prop] > JSON.parse(value),
            '=': (prop, value) => record => {console.log('prop:'+prop +' val:'+value); return record[prop] == JSON.parse(value);},
    ...
    function get(context, tokens, query, body) {
        ...
        try {
            if (query.where) {
                console.log('Collection: '+context.storage.get(context.params.collection));
                console.log(parseWhere(query.where));
    ...
    function createInstance(seedData = {}) {
            ...
            for (let [key, entry] of [...targetCollection.entries()]) {
                ...
                for (let prop in entry) {
                    if (query.hasOwnProperty(prop)) {
                        ...
                        console.log('COmpare: '+targetValue.toLocaleLowerCase() + ' : '+entry[prop].toLocaleLowerCase());
        ...
        return { get, add, set, merge, delete: del, query, getCollections };
    }
    ...
    function initPlugin$1(settings) {
        ...
        return function decorateContext(context, request) {
            ...
            function login(body) {
                console.log(identity + " "+JSON.stringify(body));
                const targetUser = context.protectedStorage.query('users', { [identity]: body[identity] });
                console.log('login: '+targetUser);
            ...
            function logout() {
                console.log("logout ctx: "+context.user._id);
            ...
            function findSessionByToken(userToken) {
                console.log(context.protectedStorage.getCollections().get('users'));
                console.log(context.protectedStorage.getCollections().get('sessions'));
