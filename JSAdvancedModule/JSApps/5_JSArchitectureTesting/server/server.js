(function (global, factory) {
    ...
    const data = fs__default['default'].existsSync('./server/data') ? fs__default['default'].readdirSync('./server/data').reduce((p, c) => {
        const content = JSON.parse(fs__default['default'].readFileSync('./server/data/' + c));
