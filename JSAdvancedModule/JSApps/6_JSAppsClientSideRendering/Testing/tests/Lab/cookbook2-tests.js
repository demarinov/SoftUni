...
describe('E2E cookbook2 tests', function () {
    ...
    it('1. Loads catalog page', async function () {
        await page.goto('http://127.0.0.1:5500/main/Lab/02.%20Cookbook/index.html');
        // await page.screenshot({ path: `index.png` });

        const selectorTitle1 = '.preview:nth-child(1) .title h2';
        const selectorTitle2 = '.preview:nth-child(2) .title h2';
        const selectorTitle3 = '.preview:nth-child(3) .title h2';

        const content1 = await page.textContent(selectorTitle1);
        const src1 = await page.getAttribute('.preview:nth-child(1) .small img', 'src');
        const content2 = await page.textContent(selectorTitle2);
        const src2 = await page.getAttribute('.preview:nth-child(2) .small img', 'src');
        const content3 = await page.textContent(selectorTitle3);
        const src3 = await page.getAttribute('.preview:nth-child(3) .small img', 'src');
    ...
    it('2. Testing authentication', async function () {
        await page.goto('http://127.0.0.1:5500/main/Lab/02.%20Cookbook/');
    ...
    it('3. Testing crud ops on meals', async function () {
        ...
        const nameEdit = await page.inputValue('#edit input[name="name"]');
