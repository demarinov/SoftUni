...
function updateNavigation(navType) {
    ...
    if (sessionStorage.getItem('userToken') != null) {
        ...
        document.querySelector('#profile a:nth-child(1)').
...
page('/home', homeSet);
page('/listings', listingSet);
page('/login', loginSet);
page('/register', registerSet);
page('/create', createSet);
page('/logout', logout);
page('/details/:id', carDetailsSet);
