...
public class GenericArray<T extends Comparable> implements Comparable<T> {
    ...
    public GenericArray(Class<T> cl) {
    ...
    public static void main(String[] args) {
        ...
        GenericArray<String> smartArray = new GenericArray<>(String.class);
