...
public class GenericArraySorter<T extends Comparable> implements Comparable<T> {
    ...
    public GenericArraySorter(Class<T> cl) {
    ...
    public static void main(String[] args) {
        ...
        GenericArraySorter<String> smartArray = new GenericArraySorter<>(String.class);
    ...
    public static <T extends Comparable> void sort(GenericArraySorter<T> array) {

        T[] newArray = (T[]) Array.newInstance(array.typeClass,array.size);

        for (int i = 0; i < array.size; i++) {
            newArray[i] = array.get(i);
        }
        Collections.sort(Arrays.asList(newArray), Comparable::compareTo);
        array.data = newArray;
